...
///////////////////////////////////////////////////////////////////////////
//Secret Number
let secretNumber = Math.round(Math.random() * 40);
let score = 20;
let highscore = 0;
...
document.querySelector(".check").addEventListener("click", function() {
    ...
    if (!guess) displayMessage("Invalid Input\uD83D\uDE21");
    else if (guess > 40) displayMessage("Invalid Input\uD83D\uDE21");
    else if (guess !== secretNumber) {
        document.querySelector(".message").textContent = guess > secretNumber ? "Too High\uD83D\uDE1C" : "Too Low\uD83D\uDE2D";
        score = score - 1;
        document.querySelector(".score").textContent = score;
        if (secretNumber >= 1 && secretNumber <= 20) document.querySelector(".number2").textContent = `The Secret Number is between 1 and 20`;
        else if (secretNumber >= 21 && secretNumber <= 40) document.querySelector(".number2").textContent = `The Secret Numberr is between 21 and 40`;
        if (score === 15) {
            if (secretNumber >= 1 && secretNumber <= 10) alert(`Hint: The secret number is from 1 - 10`);
            else if (secretNumber >= 11 && secretNumber <= 20) alert(`Hint: The secret number is from 11 - 20`);
            else if (secretNumber >= 21 && secretNumber <= 30) alert(`Hint: The secret number is from 21 - 30`);
            else if (secretNumber >= 31 && secretNumber <= 40) alert(`Hint: The secret number is from 31 - 40`);
        }
    } else if (guess === secretNumber) {
        displayMessage("You Got It Right\uD83D\uDC4C");
        document.querySelector(".number").textContent = secretNumber;
        document.querySelector(".head-message").textContent = "YOU ARE CORRECT!!!";
        document.querySelector(".head-message").style.color = "green";
        document.querySelector(".theNav").style.background_color = "green";
        document.querySelector(".thesvg").style.bootstrap = "d-none";
        if (score > highscore) {
            highscore = score;
...
document.querySelector(".again").addEventListener("click", function() {
    score = 20;
    secretNumber = Math.round(Math.random() * 40);
    document.querySelector(".number").textContent = "?";
    document.querySelector(".guess").value = "";
    document.querySelector(".head-message").textContent = "GUESS THE NUMBER?";
    document.querySelector(".head-message").style.color = "black";
    document.querySelector(".score").textContent = 20;
    displayMessage("Start Guessing...");
    document.querySelector(".number2").textContent = `Guess a number from 1 - 40`;
});
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fSEX7","aitAD"], "aitAD", "parcelRequiree563")
